...
SH
  chmod +x "$fakebin/tmux"
  for marker in hash count stale stale-since paused paused-rechecked paused-resurfaced wedge-escalations churn-since writing-since writing-resurfaced waiting-resurfaced; do
