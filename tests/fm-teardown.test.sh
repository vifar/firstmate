...
SH
  ...
  rc=0
  FM_ROOT_FOR_TEARDOWN=$(dirname "$teardown_bin")/..
  FM_ROOT_OVERRIDE="$FM_ROOT_FOR_TEARDOWN" FM_HOME="$ROOT" FM_STATE_OVERRIDE="$case_dir/state" FM_DATA_OVERRIDE="$case_dir/data" \
